...
#ifndef LV_ATTRIBUTE_ALARM
#define LV_ATTRIBUTE_ALARM
#endif

static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_ALARM
uint8_t alarm_map[] = {
